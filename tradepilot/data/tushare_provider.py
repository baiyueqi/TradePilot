...
class TushareProvider(DataProvider):
    ...
    def get_stock_daily(self, stock_code: str, start_date: str, end_date: str) -> pd.DataFrame:
        return sanitize_for_json(self._client.get_stock_daily(stock_code, start_date, end_date))

    def get_stock_weekly(self, stock_code: str, start_date: str, end_date: str) -> pd.DataFrame:
        return sanitize_for_json(self._client.get_stock_weekly(stock_code, start_date, end_date))

    def get_stock_monthly(self, stock_code: str, start_date: str, end_date: str) -> pd.DataFrame:
        return sanitize_for_json(self._client.get_stock_monthly(stock_code, start_date, end_date))

    def get_index_daily(self, index_code: str, start_date: str, end_date: str) -> pd.DataFrame:
        return sanitize_for_json(self._client.get_index_daily(index_code, start_date, end_date))
    ...
    def get_stock_valuation(self, stock_code: str, start_date: str, end_date: str) -> pd.DataFrame:
        return sanitize_for_json(self._client.get_stock_valuation(stock_code, start_date, end_date))
    ...
    def get_stock_sector(self, stock_code: str, as_of_date: str | None = None) -> pd.DataFrame:
        logger.warning("tushare provider: stock sector not implemented for {}", stock_code)
        return pd.DataFrame({
            "stock_code": pd.Series(dtype="object"),
            "sector": pd.Series(dtype="object"),
